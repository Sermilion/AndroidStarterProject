package io.readian.uniapp.core.designsystem.icon
...
public val io.readian.uniapp.core.designsystem.icon.ReadianIcons.UserPlaceholder: ImageVector
  get() {
    if (_UserPlaceholder != null) {
      return _UserPlaceholder!!
    }
    _UserPlaceholder = Builder(
      name = "User-female-svgrepo-com", defaultWidth =
